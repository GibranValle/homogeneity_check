...
export const Viewer: FC = () => {
    ...
    useEffect(() => {
        ...
        if (element && cornerstoneImage) {
            if (image.name === 'NA') dispatch(setUpdater({ updateViewport }))
            ...
            // // Retrieve image data
            // const imageData = cornerstone.getImage(element);
            // const pixelData: any = imageData.getPixelData();
            // const imageWidth = imageData.columns;

            // toolState.data.map((roi: any) => {
            //     // Calculate statistics
            //     const stats = calculateRoiStatistics(pixelData, roi, imageWidth)
            //     console.log(stats)
            // }
            // )
        }
